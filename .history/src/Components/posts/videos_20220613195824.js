...
class Editor extends React.Component {
  ...
  componentDidMount = () => {
    ...
    this.playVideo.current.addEventListener("timeupdate", function () {
      ...
      if (
        ...
        self.playVideo.current.currentTime >= self.state.timings[curr_idx].end
      ) {
    ...
    this.setState(
      ...
      () => {
        ...
        this.progressBar.current.style.left = `${
          (this.state.timings[0].start / this.playVideo.current.duration) * 100
        }%`;
      ...
      if (
        ...
        self.setState(
          ...
          () => {
            ...
            self.progressBar.current.style.left = `${
              (self.state.timings[0].start / self.playVideo.current.duration) *
              100
            }%`;
            self.progressBar.current.style.width = "0%";
          }
  ...
  updateProgress = (event) => {
    ...
    this.setState(
      ...
      () => {
        ...
        this.progressBar.current.style.left = `${
          (this.state.timings[index].start / this.playVideo.current.duration) *
          100
        }%`;
  ...
  addActiveSegments = () => {
    ...
    colors += `, rgb(240, 240, 240) ${
      (this.state.timings[counter - 1].end / this.playVideo.current.duration) *
      100
    }%, rgb(240, 240, 240) 100%`;
